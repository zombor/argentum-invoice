...
class Auto_Modeler extends Model
{
	...
	public function save($extra_data = array(), $extra_validation_methods = array(), $extra_callbacks = array())
	{
		...
		foreach ($extra_callbacks as $field => $callback)
			$data->add_callbacks($field, array($this, $callback_function));
