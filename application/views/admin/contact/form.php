<div id="contact_form">
	...
	<ul>
		...
		<li><label for="project_client_id">Assigned Clients:</label><br /><br /><br />
			<?php foreach ($clients as $client):?><?=form::checkbox('client['.$client->id.']', $client->id, $contact->has('clients', $client->id))?> <?=$client->company_name?><br />
			<?php endforeach; ?>
