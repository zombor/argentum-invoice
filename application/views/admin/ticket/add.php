...
<ul>
	...
	<li><label for="operation_type_id">Operation:</label> <?=form::dropdown('operation_type_id', Auto_Modeler_ORM::factory('operation_type')->select_list('id', 'name'), isset($operation_type_id) ? $operation_type_id : $ticket->operation_type_id)?></li>
