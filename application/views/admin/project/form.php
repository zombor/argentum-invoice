<div id="project-form">
    ...
    <ul>
    	...
    	<?=form::dropdown(array('name' => 'project[client_id]',
    	                        'id' => 'project_client_id'), Auto_Modeler_ORM::factory('client')->select_list('id', 'company_name') + array('new' => 'New Client...'), $project->client_id)?></li>
    ...
    <ul>
    	...
    	<li class="clear"><label for="client_mailing_address">Mailing Address:</label><br />
